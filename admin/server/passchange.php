...
elseif($_POST["newpassword"] != $_POST["confirmpassword"]){
    ...
    $updatesql2 = "UPDATE add_teacher SET Password = '".$_POST["newpassword"]."' WHERE Id = '".$_SESSION['Id']."'";
    if($con->query($updatesql) === TRUE AND $con->query($updatesql2) === TRUE){
        echo '<script language="javascript">';
        echo 'alert("Password Changed Added Successfully"); location.href="../../teacher/profile.php"';
        echo '</script>';
    }
    else{
        echo "fail";
